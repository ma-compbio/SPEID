...
# model parameters
n_kernels = 900 # Number of kernels; used to be 1024
LSTM_out_dim = 256 # Output direction of ONE DIRECTION of LSTM; used to be 512
...
model.add(Flatten())
model.add(Dense(output_dim = 100, # used to be 925
                    activation = "relu"))
model.add(Dense(output_dim = 1,
                    activation = "sigmoid"))

print 'Loading weights...'
model.load_weights('/home/sss1/Desktop/projects/DeepInteractions/weights/myDanQ-JASPAR_bestmodel-2016-08-03-13:28:59.hdf5')
